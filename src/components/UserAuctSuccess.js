...
function Success() {
  ...
  let data=  {seller , amount , buyername , pincode , id , bidId, buyerid }

  // useEffect(async ()=>{

  //   await axios.post("https://3.6.225.138/api/auct/stripe/Tra", data);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const auctionTra =  await axios.post("https://3.6.225.138/api/auct/stripe/Tra", data);
  
        

       
        const status = await axios.put("https://3.6.225.138/api/auct/status", data);
